...
#define TEST_PIN1           IfxGtm_TOM1_12_TOUT4_P02_4_OUT          /* LED which will be driven by the PWM          */
#define PWM_PERIOD          7899                                /* PWM period for the TOM                       */
#define FADE_STEP           PWM_PERIOD / 100                        /* PWM duty cycle for the TOM                   */

/*********************************************************************************************************************/
/*-------------------------------------------------Global variables--------------------------------------------------*/
/*********************************************************************************************************************/
extern uint32 m_dutyCycle;
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.clock = IfxGtm_Tom_Ch_ClkSrc_cmuFxclk2;
    g_tomConfig.tom = TEST_PIN1.tom;                                      /* Select the TOM depending on the LED          */
    ...
    g_tomConfig.dutyCycle = PWM_PERIOD/20;
